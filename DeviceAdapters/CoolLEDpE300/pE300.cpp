...
//-----------------------------------------------------------------------------
// DESCRIPTION:   pE-300 light source controller adapter
...
// Controller
const char* g_ControllerName = "pE300";
...
int Controller::Initialize()
{
	...
	int rlt = (int)buf_string_.find("pE-300");
	if (rlt < 0) {
		strError = "\r\n\r\nIncompatible device driver!\r\n";
		strError += "The driver loaded: CoolLED-pE300\r\n";
