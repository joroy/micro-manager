...
int XLedCtrl::Initialize()
{
    ...
    // Create read-only property for speaker bolume info
...
int XLedCtrl::OnAllOnOff(MM::PropertyBase* pProp, MM::ActionType pAct)
{
    std::ostringstream osMessage;
    int nDebugLog = XLed::Instance()->GetDebugLogFlag();
    unsigned char sCmdSet[8] = { 0x6F, 0x6E, 0x3D, 0x61, XLed::XL_TxTerm, 0x00, 0x00, 0x00 };
...
int XLedCtrl::OnPWMStatus(MM::PropertyBase* pProp, MM::ActionType pAct)
{
    ...
    unsigned char sCmdSet[8] = { 0x69, 0x73, 0x3D, 0x30, XLed::XL_TxTerm, 0x00, 0x00, 0x00 };
...
int XLedCtrl::OnPWMMode(MM::PropertyBase* pProp, MM::ActionType pAct)
{
    ...
    unsigned char sCmdSet[6] = { 0x73, 0x63, 0x3D, 0x30, XLed::XL_TxTerm, 0x00 };
...
int XLedCtrl::OnFrontPanelLock(MM::PropertyBase* pProp, MM::ActionType pAct)
{
    ...
    unsigned char sCmdSet[8] = { 0x6C, 0x6F, XLed::XL_TxTerm, 0x00, 0x00, 0x00, 0x00, 0x00 };
...
int XLedCtrl::OnLCDScrnNumber(MM::PropertyBase* pProp, MM::ActionType pAct)
{
    ...
    unsigned char sCmdSet[8] = { 0x73, 0x73, 0x3D, 0x32, XLed::XL_TxTerm, 0x00, 0x00, 0x00 };
