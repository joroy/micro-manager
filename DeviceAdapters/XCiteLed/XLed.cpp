...
XLed::XLed()
{
    XLed::m_sXLedStr[XLed::XL_CtrlBoardName]            = "XLED1 Controller";                         // 00: XLed controller device name
    XLed::m_sXLedStr[XLed::XL_CtrlBoardDesc]            = "XLED1 Controller";                         // 01: XLed controller device name
    XLed::m_sXLedStr[XLed::XL_WLedDevName]              = "LED1 Device";                              // 02: W LED device name
    XLed::m_sXLedStr[XLed::XL_XLedDevName]              = "LED2 Device";                              // 03: X LED device name
    XLed::m_sXLedStr[XLed::XL_YLedDevName]              = "LED3 Device";                              // 04: Y LED device name
    XLed::m_sXLedStr[XLed::XL_ZLedDevName]              = "LED4 Device";                              // 05: Z LED device name
    XLed::m_sXLedStr[XLed::XL_WLedDevDesc]              = "LED1 Device";                              // 06: W LED device name
    XLed::m_sXLedStr[XLed::XL_XLedDevDesc]              = "LED2 Device";                              // 07: X LED device name
    XLed::m_sXLedStr[XLed::XL_YLedDevDesc]              = "LED3 Device";                              // 08: Y LED device name
    XLed::m_sXLedStr[XLed::XL_ZLedDevDesc]              = "LED4 Device";                              // 09: Z LED device name
    XLed::m_sXLedStr[XLed::XL_XLedSoftVer]              = "v1.03.020";                                // 10: XLed Software Version
    ...
    XLed::m_sXLedStr[XLed::XL_XLedSoftVerLabel]         = "X.04 XCiteLed Software Version";           // 16: XLed Software Version Label
    ...
    XLed::m_sXLedStr[XLed::XL_XLedStatusLabel]          = "X.07 Status (0-FFFF)";                     // 19: XLed status label
    ...
    XLed::m_sXLedStr[XLed::XL_LedSerialNoLabel]         = "L.03 Serial Number";                       // 33: Led device serial number label
    XLed::m_sXLedStr[XLed::XL_LedMfgDateLabel]          = "L.04 Manufacturing Date";                  // 34: Led device manufacturing date label
    XLed::m_sXLedStr[XLed::XL_LedWaveLengthLabel]       = "L.05 WaveLength";                          // 35: Led device wavelength label
    XLed::m_sXLedStr[XLed::XL_LedFWHMLabel]             = "L.06 FWHM Value";                          // 36: Led device FWHM value label
    XLed::m_sXLedStr[XLed::XL_LedStatusLabel]           = "L.07 Status Byte (0-FF)";                  // 37: Led device status Label
    XLed::m_sXLedStr[XLed::XL_LedStatusDescLabel]       = "L.07 Status Description";                  // 38: Led device status description Label
    XLed::m_sXLedStr[XLed::XL_LedHoursLabel]            = "L.08 Hours Elapsed";                       // 39: Led device number of hours label
    XLed::m_sXLedStr[XLed::XL_LedOnOffStateLabel]       = "L.09 On/Off State (1=On 0=Off)";           // 40: Led device ON/OFF state label
    XLed::m_sXLedStr[XLed::XL_LedIntensityLabel]        = "L.10 Intensity (0.0 or 5.0 - 100.0)%";     // 41: Led device intensity label
